...
Follow this link then copy and paste it inside of your terminal then hit enter (You must be root): [Install Helper](https://raw.githubusercontent.com/urnetwork/connect/refs/heads/main/scripts/Provider_Install_Deps.sh).
