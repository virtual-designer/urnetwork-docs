...
| `-e ENABLE_IP_CHECKER` | Optional | Boolean **true**/**false**<br /><br />Checks and prints your public IPv4 address to stdout visible directly in Docker logs for easy monitoring. |
...
| `-e ENABLE_VNSTAT` | Optional | Boolean **true**/**false**<br /><br />Default is True. |
