...
- **Auth Code:** A valid JSON Web Token (JWT) issued for your URnetwork account. Generate one here: https://ur.io/, https://app.ur.network/ or inside the app (see screenshots). Auth Codes expire after a set time and are usually one use unless set otherwise.
